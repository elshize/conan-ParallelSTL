...
set(CONAN_PARALLELSTL_ROOT "/home/elshize/.conan/data/ParallelSTL/20181004/elshize/stable/package/fa96d37a2495ebb462d3fa1042f0061d0e44d81e")
set(CONAN_INCLUDE_DIRS_PARALLELSTL "/home/elshize/.conan/data/ParallelSTL/20181004/elshize/stable/package/fa96d37a2495ebb462d3fa1042f0061d0e44d81e/include")
set(CONAN_LIB_DIRS_PARALLELSTL )
set(CONAN_BIN_DIRS_PARALLELSTL )
set(CONAN_RES_DIRS_PARALLELSTL )
set(CONAN_BUILD_DIRS_PARALLELSTL "/home/elshize/.conan/data/ParallelSTL/20181004/elshize/stable/package/fa96d37a2495ebb462d3fa1042f0061d0e44d81e/")
set(CONAN_LIBS_PARALLELSTL )
set(CONAN_DEFINES_PARALLELSTL )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_PARALLELSTL )

set(CONAN_C_FLAGS_PARALLELSTL "")
set(CONAN_CXX_FLAGS_PARALLELSTL "")
set(CONAN_SHARED_LINKER_FLAGS_PARALLELSTL "")
set(CONAN_EXE_LINKER_FLAGS_PARALLELSTL "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_PARALLELSTL_LIST "")
set(CONAN_CXX_FLAGS_PARALLELSTL_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_PARALLELSTL_LIST "")
set(CONAN_EXE_LINKER_FLAGS_PARALLELSTL_LIST "")


set(CONAN_TBB_ROOT "/home/elshize/.conan/data/TBB/2018_U5/conan/stable/package/160b4bac5177b0f9a5f4857d00317fe0862a8a02")
set(CONAN_INCLUDE_DIRS_TBB "/home/elshize/.conan/data/TBB/2018_U5/conan/stable/package/160b4bac5177b0f9a5f4857d00317fe0862a8a02/include")
set(CONAN_LIB_DIRS_TBB "/home/elshize/.conan/data/TBB/2018_U5/conan/stable/package/160b4bac5177b0f9a5f4857d00317fe0862a8a02/lib")
set(CONAN_BIN_DIRS_TBB )
set(CONAN_RES_DIRS_TBB )
set(CONAN_BUILD_DIRS_TBB "/home/elshize/.conan/data/TBB/2018_U5/conan/stable/package/160b4bac5177b0f9a5f4857d00317fe0862a8a02/")
...
set(CONAN_DEPENDENCIES ParallelSTL TBB)
...
set(CONAN_INCLUDE_DIRS "/home/elshize/.conan/data/ParallelSTL/20181004/elshize/stable/package/fa96d37a2495ebb462d3fa1042f0061d0e44d81e/include"
			"/home/elshize/.conan/data/TBB/2018_U5/conan/stable/package/160b4bac5177b0f9a5f4857d00317fe0862a8a02/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "/home/elshize/.conan/data/TBB/2018_U5/conan/stable/package/160b4bac5177b0f9a5f4857d00317fe0862a8a02/lib" ${CONAN_LIB_DIRS})
set(CONAN_BIN_DIRS  ${CONAN_BIN_DIRS})
set(CONAN_RES_DIRS  ${CONAN_RES_DIRS})
set(CONAN_LIBS tbb tbbmalloc tbbmalloc_proxy ${CONAN_LIBS})
set(CONAN_DEFINES  ${CONAN_DEFINES})
set(CONAN_CMAKE_MODULE_PATH "/home/elshize/.conan/data/ParallelSTL/20181004/elshize/stable/package/fa96d37a2495ebb462d3fa1042f0061d0e44d81e/"
			"/home/elshize/.conan/data/TBB/2018_U5/conan/stable/package/160b4bac5177b0f9a5f4857d00317fe0862a8a02/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    conan_package_library_targets("${CONAN_LIBS_PARALLELSTL}" "${CONAN_LIB_DIRS_PARALLELSTL}"
                                  CONAN_PACKAGE_TARGETS_PARALLELSTL "CONAN_PKG::TBB" "" ParallelSTL)
    conan_package_library_targets("${CONAN_LIBS_PARALLELSTL_DEBUG}" "${CONAN_LIB_DIRS_PARALLELSTL_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_PARALLELSTL_DEBUG "CONAN_PKG::TBB" "debug" ParallelSTL)
    conan_package_library_targets("${CONAN_LIBS_PARALLELSTL_RELEASE}" "${CONAN_LIB_DIRS_PARALLELSTL_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_PARALLELSTL_RELEASE "CONAN_PKG::TBB" "release" ParallelSTL)

    add_library(CONAN_PKG::ParallelSTL INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::ParallelSTL PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_PARALLELSTL} ${CONAN_SHARED_LINKER_FLAGS_PARALLELSTL_LIST} ${CONAN_EXE_LINKER_FLAGS_PARALLELSTL_LIST}
                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_PARALLELSTL_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_PARALLELSTL_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_PARALLELSTL_RELEASE_LIST}>
                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_PARALLELSTL_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_PARALLELSTL_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_PARALLELSTL_RELEASE_LIST}>
                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_PARALLELSTL_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_PARALLELSTL_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_PARALLELSTL_RELEASE_LIST}>
                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_PARALLELSTL_DEBUG} ${CONAN_SHARED_LINKER_FLAGS_PARALLELSTL_DEBUG_LIST} ${CONAN_EXE_LINKER_FLAGS_PARALLELSTL_DEBUG_LIST}>
                                                                 CONAN_PKG::TBB)
    set_property(TARGET CONAN_PKG::ParallelSTL PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_PARALLELSTL}
                                                                      $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_PARALLELSTL_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_PARALLELSTL_RELEASE}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_PARALLELSTL_RELEASE}>
                                                                      $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_PARALLELSTL_DEBUG}>)
    set_property(TARGET CONAN_PKG::ParallelSTL PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_PARALLELSTL}
                                                                      $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_PARALLELSTL_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_PARALLELSTL_RELEASE}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_PARALLELSTL_RELEASE}>
                                                                      $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_PARALLELSTL_DEBUG}>)
    set_property(TARGET CONAN_PKG::ParallelSTL PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_PARALLELSTL_LIST} ${CONAN_CXX_FLAGS_PARALLELSTL_LIST}
                                                                  $<$<CONFIG:Release>:${CONAN_C_FLAGS_PARALLELSTL_RELEASE_LIST} ${CONAN_CXX_FLAGS_PARALLELSTL_RELEASE_LIST}>
                                                                  $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_PARALLELSTL_RELEASE_LIST} ${CONAN_CXX_FLAGS_PARALLELSTL_RELEASE_LIST}>
                                                                  $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_PARALLELSTL_RELEASE_LIST} ${CONAN_CXX_FLAGS_PARALLELSTL_RELEASE_LIST}>
                                                                  $<$<CONFIG:Debug>:${CONAN_C_FLAGS_PARALLELSTL_DEBUG_LIST}  ${CONAN_CXX_FLAGS_PARALLELSTL_DEBUG_LIST}>)
    ...
    set(CONAN_TARGETS CONAN_PKG::ParallelSTL CONAN_PKG::TBB)
